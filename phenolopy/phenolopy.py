...
This copy of Phenolopy was pulled from https://github.com/frontiersi/phenolopy/ on 2022/06/28 by Nick Santos.
Phenolopy is distributed under an Apache License Version 2.0: https://github.com/frontiersi/phenolopy/blob/main/LICENSE
It is not an original work of this project and credit (and thanks) for Phenolopy go to Lewis Trotter and Frontier SI.
It has been modified to remove the `datacube` import because this project will not use DEA DataCube data.
'''
...
def remove_outliers(ds, method='median', user_factor=2, z_pval=0.05, force_1d=True):
	"""
	...
	if len(ds['veg_index'].shape) == 1 and not force_1d:
...
def smooth(ds, method='savitsky', window_length=3, polyorder=1, sigma=1, force_1d=False):
	"""
